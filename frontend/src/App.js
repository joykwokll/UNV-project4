  ...
  return (
    ...
    <HeaderBar/>
      <Routes>
        ...
        <Route path="antiaging" element={<Antiaging />}></Route>
        <Route path="pigmentation" element={<Pigmentation />}></Route>
        <Route path="sensitiveskin" element={<Sensitiveskin />}></Route>
        <Route path="pimple" element={<Pimple />}></Route>
        <Route path="beautytips" element={<Tips />}></Route>
